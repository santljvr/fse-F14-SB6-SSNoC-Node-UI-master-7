...
module.exports = {
  ...
  //search: Santosh
  'getSearch' : host_url + '/search',
  'searchByUser' : host_url + '/search/username',
  
  //'searchByStatus' : host_url + '/search/status',
  //'searchPubMsg' : host_url + '/search/publicMessage',
  //'searchAnnouncement' : host_url + '/search/announcement',
  //'searchChat' : host_url + '/search/chats',
